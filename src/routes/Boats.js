            ...
            {!isLoading && (
                <main className="p-10">
                    ...
                    <section className="flex justify-center mt-4">
                        <button className={`bg-gray-900 hover:bg-gray-700 py-2 px-4 text-white rounded-l ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
                                onClick={handleFirstPage}
                                disabled={currentPage === 1}>
                            <span className="material-symbols-outlined">first_page</span>
                        </button>
                        <button className={`bg-gray-900 hover:bg-gray-700 py-2 px-4 text-white ${currentPage === 1 ? 'opacity-50 cursor-not-allowed' : ''}`}
                        ...
                        <button className={`bg-gray-900 hover:bg-gray-700 py-2 px-4 text-white ${currentPage * itemLimit >= boatData.pagination.totalItems ? 'opacity-50 cursor-not-allowed' : ''}`}
                                onClick={handleNextPage}
                                disabled={currentPage * itemLimit >= boatData.pagination.totalItems}>
                            <span className="material-symbols-outlined">navigate_next</span>
                        </button>
                        <button className={`bg-gray-900 hover:bg-gray-700 py-2 px-4 text-white rounded-r ${currentPage === boatData.pagination.totalPages ? 'opacity-50 cursor-not-allowed' : ''}`}
